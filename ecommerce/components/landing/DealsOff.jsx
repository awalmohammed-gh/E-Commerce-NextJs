...
export default function DealsOff() {
  const dealsOffData = products.slice(0, 8).sort(() => 0.5 - Math.random());
      ...
      <div className="container mx-auto">
        ...
        >
          <div className="flex items-center gap-3">
            <TagIcon className="w-6 h-6 sm:w-7 sm:h-7 text-green-600" />
        ...
        {dealsOffData.length > 0 ? (
          <motion.div
            ...
            viewport={{ once: true }}
          >
            {dealsOffData.map((product, index) => (
              <motion.div
                key={index}
